...
import { Award, Users, GraduationCap, Globe, BookOpen, ChevronRight, HeartHandshake } from 'lucide-react';
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              {[
                ...
                {
                  icon: <HeartHandshake size={40} className="text-primary-600 mx-auto mb-4" />,
                  title: 'Trusted Guidance',
                  description: 'We build trust through transparent and personalized support at every step.'
                }
              ].map((item, index) => (
